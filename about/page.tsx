            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8 animate-fade-in">
                <div className="inline-flex px-4 py-2 rounded-full border border-primary/30 bg-primary/5 backdrop-blur-sm">
                  <span className="text-sm font-semibold text-primary">👋 Hello, I'm Julian</span>
                </div>
                
                <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                  <span className="text-foreground">Full Stack</span>
                  <span className="gradient-text block">Developer</span>
                  <span className="text-foreground text-2xl md:text-3xl mt-4 block">From Cianjur, Indonesia</span>
                </h1>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
            <div className="mb-16 text-center">
              ...
              <p className="text-xl text-muted-foreground">Perjalanan saya dalam berkembang sebagai developer, terus berevolusi melalui pembelajaran, eksperimen, dan membangun proyek nyata</p>
            </div>
