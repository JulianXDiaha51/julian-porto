    ...
    <section className="relative min-h-screen flex items-center overflow-hidden py-20 px-4 pt-32">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          >
            Full-stack developer dari Cianjur dengan passion dalam membangun aplikasi yang scalable, modern, dan user-friendly. Saya menggabungkan keahlian teknis dengan kreativitas dalam memecahkan masalah untuk menghasilkan solusi terbaik.
          </p>
          ...
          <div className="flex gap-3 mb-16 animate-slide-in-up" style={{ animationDelay: "300ms" }}>
            {[
              { icon: Github, href: "https://github.com/JulianXDiaha51", label: "GitHub" },
              { icon: Linkedin, href: "https://linkedin.com/JulzzRzy", label: "LinkedIn" },
              { icon: Mail, href: "mailto:julzzpedia@gmail.com", label: "Email" },
            ].map((social, i) => {
