          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground">
                Based in Cianjur, Indonesia. Always open to collaborating with teams remotely or meeting in person.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-8">
                ...
                <div className="rounded-lg border border-border bg-card/50 p-8">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Currently based in West Java, Indonesia. I work with clients worldwide and am flexible with time
                    zones.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-8">
                <div className="rounded-lg border border-border overflow-hidden bg-card h-96 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-1">Cianjur, Indonesia</h4>
                      <p className="text-sm text-muted-foreground">West Java, Indonesia</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-border bg-card/50 p-6 space-y-4">
                  <h4 className="font-semibold text-foreground">Why Cianjur?</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Cianjur offers a calm environment, comfortable surroundings, and a growing community. It’s an ideal place to think clearly, learn, and develop innovative digital products.
                  </p>
