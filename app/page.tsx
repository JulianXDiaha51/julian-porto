          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
                Full Stack Developer dari Cianjur, Indonesia. Spesialis dalam membangun aplikasi web modern, scalable, dan user-friendly dengan teknologi terkini.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Berkomitmen pada kualitas, inovasi, dan kepuasan klien di setiap project
              </p>
            </motion.div>
        ...
        <section className="py-24 md:py-32 border-y border-border bg-gradient-to-b from-card/30 to-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Pendekatan terstruktur untuk memastikan kesuksesan project dari awal hingga peluncuran
              </p>
            </motion.div>
        ...
        <section className="py-24 md:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Testimoni klien tentang pengalaman mereka dengan saya.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  content: "Julian delivered exceptional work on our e-commerce platform. His attention to detail and technical expertise went beyond our expectations",
                  rating: 5
                },
                {
                  name: "Alex Rodriguez",
                  role: "Buyer",
                  company: "Nexus Labs",
                  content: "Working with Julian was a game-changer for our business. He turned our complex requirements into a beautiful and highly functional product.",
                  rating: 5
                },
                {
                  name: "Maya Patel",
                  ...
                  content: "Professional, reliable, and incredibly talented. Julian ability to understand design intent and translate it into code is remarkable.",
                  rating: 5
                }
